...
import cjaShort from '../../../public/assets/img/cjaShort.svg'
import cjaLong from '../../../public/assets/img/cjaLong.svg'
        ...
        <header className="w-full mx-auto px-4 py-4 flex justify-between items-center gap-4 backdrop-blur-lg sticky top-0 z-50">
            <Link href="/" className="hidden md:block" >
              <Image 
                src={cjaLong}
                height={40}
                alt="chicago jazz assembly logo"
              />
            </Link>
            ...
            <div className="flex gap-8 items-center">
              ...
              <Link
                href='/contact'
                className={`text-sm cursor-pointer font-bold px-4 py-2 w-max rounded-full transition-all duration-500 bg-slate-900 hover:bg-amber-400 text-white hover:scale-110`}
              >
                Contact
              </Link>
            </div>
