...
const WhySection: React.FC = () => {
  return (
    <section className="rounded-xl flex flex-col justify-start items-center gap-8 mx-auto w-full max-w-6xl">
      <h2 className="font-bold text-3xl text-left w-full">Why book with us?</h2>

      <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-8">
          <div className="w-full flex flex-col gap-3 bg-slate-100/50 rounded-xl p-6">
